...
const HospedajesSearch = () => {
  ...
  const deleteRow = async rowKey => {
    ...
    let response = await deleteHospedaje(rowKey);
  ...
  return (
    <>
      <Container>
        ...
        <TopContainer>
          <SearchInput
            placeholderText="Buscar Hospedajes..."
...
export default HospedajesSearch;
