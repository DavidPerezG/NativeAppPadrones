...
const CasasDeEmpenioSearch = () => {
  ...
  const searchEmpresa = async () => {
    ...
    response = await getCasasDeEmpenio(
      razon_social,
      nombre_comercial,
      RFC,
      currentPage.current,
  ...
  const deleteRow = async rowKey => {
    ...
    let response = await deleteCasaDeEmpenio(rowKey);
  ...
  return (
    <>
      <Container>
        ...
        <TopContainer>
          <SearchInput
            placeholderText="Buscar Casa de Empeño..."
...
export default CasasDeEmpenioSearch;
